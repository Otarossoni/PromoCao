...
Route::group(['prefix'=>'consumidores', 'where'=>['consumidor_id'=>'[0-9]+']], function() {
    Route::get('', ['as'=>'consumidores', 'uses'=>'\App\Http\Controllers\ConsumidoresController@index']);
...
Route::group(['prefix'=>'promocoes', 'where'=>['promocao_id'=>'[0-9]+']], function() {
    Route::get('', ['as'=>'promocoes', 'uses'=>'\App\Http\Controllers\PromocaosController@index']);
...
Route::group(['prefix'=>'denuncias', 'where'=>['denuncia_id'=>'[0-9]+']], function() {
    Route::get('', ['as'=>'denuncias', 'uses'=>'\App\Http\Controllers\DenunciasController@index']);
...
Route::group(['prefix'=>'comentarios', 'where'=>['comentario_id'=>'[0-9]+']], function() {
    Route::get('', ['as'=>'comentarios', 'uses'=>'\App\Http\Controllers\ComentariosController@index']);
